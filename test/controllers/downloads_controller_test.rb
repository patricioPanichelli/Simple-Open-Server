...
class DownloadsControllerTest < ActionController::TestCase
  ...
  test "should create download" do
    assert_difference('Download.count') do
      post :create, download: { email: @download.email, firstName: @download.firstName, lastName: @download.lastName, link: @download.link }
    end
  ...
  test "should update download" do
    patch :update, id: @download, download: { email: @download.email, firstName: @download.firstName, lastName: @download.lastName, link: @download.link }
    assert_redirected_to download_path(assigns(:download))
  end
